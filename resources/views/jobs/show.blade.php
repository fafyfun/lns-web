                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form role="form" action="{{ url('/search/Job') }}" method="GET">
                                <div class="input-group">
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="col-xs-3">--}}
                                    <input style="margin-top: 5px;" type="text" class="form-control" id="search" name="search" placeholder="Job No" value="{{ $search or '' }}" >
                                    {{--</div>--}}
                ...
                <div class="panel-body">
                    ...
                    @if($jobs->count() > 0)
                        ...
                        <div style="overflow-x:auto;">
                            <div style="float:right"><h1>Total:{{ $jobs->total() }}</h1></div>
                            <table data-toggle="table" id="example2" data-row-style="rowStyle">
                                ...
                                @foreach ($jobs as $job)
                                    <tr>
                                        ...
                                        <td>{{ 'job_'.sprintf('%08d', $job->id) }}</td>
                                        <td><a  href='{{  url("/installations/{$job->installation->id}/view") }}'><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                        <td>
                                            @if($job->status == '1')
                                        ...
                                        {{--<td>{{ $job->saleslead->customer->email }}</td>--}}
                                        ...
                                        <td><a class="link" href='{{  url("/activities/$job->id/Quotationjob") }}'><i class="fa fa-road"></i></a></td>
                                        {{--@endif--}}
                                        @php $id++; @endphp
                                    </tr>
                                @endforeach
